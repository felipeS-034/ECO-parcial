...
socket.on('/senDirections',message =>{
})
/*en este metodo atra vez de un switch case podemos darle información
para que escuche cuando las posiciones se cambian*/
